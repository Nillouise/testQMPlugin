...
void RedEye::ActShuangDao::run()
{
	...
	CDecision::getMonsterOverlay( skillArea, receive,(**m_MonToConsiderFirst).m_Mon );// it should use MonNeural
...
int RedEye::loadNeural()
{
	...
	actShuangDaoMon1->m_MonToConsiderFirst = &g_monNeural1;
	ActShuangDao *actShuangDaoMon2 = new ActShuangDao();
	actShuangDaoMon2->m_MonToConsiderFirst = &g_monNeural2;
	ActZhiChong *actZhiChong1 = new ActZhiChong();
	actZhiChong1->m_MonToConsiderFirst = &g_monNeural1;
	ActZhiChong *actZhiChong2 = new ActZhiChong();
	actZhiChong2->m_MonToConsiderFirst = &g_monNeural2;
	ActShiZiZhan *actShiZiZhan1 = new ActShiZiZhan(csShizizhan);
	actShiZiZhan1->m_MonToConsiderFirst = &g_monNeural1;
	ActShiZiZhan *actShiZiZhan2 = new ActShiZiZhan(csShizizhan);
	actShiZiZhan2->m_MonToConsiderFirst = &g_monNeural2;
...
void RedEye::ActZhiChong::run()
{
	...
	if ((*m_MonToConsiderFirst)->m_Mon.m_vecCMon.begin() != (*m_MonToConsiderFirst)->m_Mon.m_vecCMon.end())
	{
		m_bestArea.m_rect = (*m_MonToConsiderFirst)->m_Mon.m_vecCMon[0].m_rect;
	}
	else
	{
		m_selfOutput = 0;
